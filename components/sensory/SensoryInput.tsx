      ...
      <AnimatePresence>
         {showNoiseAlert && (
            <motion.div
               ...
               exit={{ opacity: 0, y: 0 }}
               className="absolute left-1/2 -translate-x-1/2 bg-amber-500 text-black px-6 py-3 rounded-full flex items-center gap-4 shadow-lg z-50 cursor-pointer font-bold"
               onClick={togglePrivacy}
            >
               <VolumeX className="w-5 h-5" />
               <div className="flex flex-col text-left">
                  <span className="text-xs uppercase tracking-wider">High Noise Detected</span>
                ...
                Array.from({ length: 20 }).map((_, i) => (
                  <motion.div
                    ...
                    animate={{ 
                      ...
                      backgroundColor: volume > 0.1 ? '#22d3ee' : '#475569' // Cyan vs Slate
                    }}
